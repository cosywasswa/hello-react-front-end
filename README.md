...
- This is hello-rails-back-end application <a href="https://github.com/cosywasswa/hello-rails-back-end">back-end Link</a>
...
```sh
  cd my-folder
  git clone https://github.com/cosywasswa/hello-react-front-end.git
```
